...
<body style="margin: 10px">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-inline">
              ...
              <div class="layui-input-inline">
                  <input type="text" id="menuNameId" name="title" autocomplete="off" class="layui-input" placeholder="请输入功能名称">
              </div>
            </div>
            <div class="layui-inline">
    ...
    <script type="text/html" id="toolbarDemo">
     <div class="layui-btn-containe">
        <button class="layui-btn-primary layui-btn-sm" lay-event="addMenuDataBtn"><i class="layui-icon">&#xe654;</i></button>
    </div>
    </script>
        ...
        <div style="display: none"  id="addMenuModel" >
            ...
            <form class="layui-form layui-form-pane" action="" lay-filter="addMenuFrame" id="addMenuFrame" style="margin: 20px">
                ...
                <div class="layui-form-item">
                    <label class="layui-form-label">功能名称</label>
                    <div class="layui-input-block">
                    <input type="text" name="title"  lay-verify="required" autocomplete="off" placeholder="请输入功能名称" class="layui-input">
                    </div>
                </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                    <input type="text" name="href" id="hrefId" autocomplete="off" placeholder="请输入功能地址" class="layui-input">
                    </div>
                </div>
                ...
                <div class="layui-form-item" pane="">
                    <label class="layui-form-label">功能属性</label>
                    <div class="layui-input-block">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                    <input type="text" name="icon"  lay-verify="required" autocomplete="off" placeholder="请输入功能图标" class="layui-input">
                    </div>
                </div>
...
<script>
    ...
    ,{field:'id', title:'功能编号',fixed: 'left', width:110, unresize: true, sort: true,align:"center"}
    ,{field:'pid', title:'父级节点',width:90,align:"center"}
    ,{field:'title', title:'功能名称',width:160,align:"center"}
    ,{field:'href', title:'功能地址',align:"center"}
    ,{field:'spread', title:'是否展开',align:"center",templet:'#switchTpl', unresize: true}
    ,{field:'target', title:'TARGET',align:"center"}
    ,{field:'icon', title:'功能图标',align:"center",width:90,templet:function(d){
    ...
    table.on('tool(personTable)', function(obj){
        ...
        $.post("${Path}/menu/checkMenuHasChildren?id="+data.id,function(result) {
            if (result.code != 200){
                layer.msg("请先删除该功能下的子节点再进行操作!",{
                    icon:5,
                    anim:6
                });
            }else {
                layer.confirm('你确定删除【'+data.title+'】功能吗?', {icon:3,title:"提示",skin:'layui-layer-molv',btnAlign:'c'}, function(){
